		...
		@if (theme()->getOption('layout', 'aside/display') === false)
			...
			<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
				<a href="{{ theme()->getPageUrl('') }}">
					<img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/default-small.svg') }}" class="h-35px"/>
				</a>
			</div>
			<!--end::Logo-->
		@else
			...
			<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
				<a href="{{ theme()->getPageUrl('') }}" class="d-lg-none">
					<img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/logo-klinik.png') }}" class="h-15px"/>
				</a>
			</div>
			<!--end::Mobile logo-->
		@endif

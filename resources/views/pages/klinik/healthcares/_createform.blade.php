<form id="kt_modal_add_permission_form" method="POST" class="form" action="{{ route('healthcares.store') }}">
{{ csrf_field() }}
<!--begin::Scroll-->
    <div class="d-flex flex-column flex-row-fluid">
        ...
        <div class="fv-row mb-7">
            ...
            <div class="input-group input-group-solid has-validation mb-3">
                <input type="text" name="name" class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('name') is-invalid @enderror" placeholder="Healthcare name" value=""/>
            </div>
            @error('name')
        ...
        <div class="fv-row mb-7">
            ...
            <!--begin::Col-->
            <div class="input-group input-group-solid has-validation mb-3">
                <select name="healthcare_type_id" aria-label="{{ __('Select a Healthcare Type') }}" data-control="select2" data-placeholder="{{ __('Select a Healthcare Type...') }}" class="form-select form-select-solid form-select-lg fw-bold">
        ...
        <div class="fv-row mb-7">
            ...
            <!--begin::Input-->
            <div class="input-group input-group-solid has-validation mb-3">
                <input type="text" name="website" class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('website') is-invalid @enderror" placeholder="Website" value=""/>
            </div>
            @error('website')
                <div class="text-danger">{{ $message }}</div>
            @enderror

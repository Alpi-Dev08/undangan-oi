...
<form method="POST" action="{{ route('skriningexaminations.update', $info->id) }}" class="card-body pt-6" id="kt_modal_edit_form">
    @csrf
    @method('PUT')
        ...
        <div class="col-lg-8">
            <div class="row">
                ...
                <div class="col-lg-6 fv-row">
                    ...
                    value="{{ old('first_name', isset($info) ? $info->first_name : '') }}" />
                ...
                <div class="col-lg-6 fv-row">
                    ...
                    value="{{ old('last_name', isset($info) ? $info->last_name : '') }}" />
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-8 fv-row">
            ...
            value="{{ old('phone', isset($info) ? $info->phone : '') }}" />
            @error('phone')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror

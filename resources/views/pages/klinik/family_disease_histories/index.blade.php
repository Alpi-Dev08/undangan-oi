        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" id="searchbox" class="form-control form-control-solid border border-gray-300 w-250px ps-15" placeholder="Cari Riwayat Penyakit Keluarga">
                </div>
            </h3>
            ...
            @if(Auth::user()->can('klinik.create'))
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                     title=""
                     data-bs-original-title="Klik untuk menambah riwayat penyakit keluarga baru">
                    <a href="{{ route('family-disease-histories.create')  }}" class="btn btn-sm btn-light-primary">
                        ...
                        <!--end::Svg Icon-->
                        Riwayat Penyakit Keluarga Baru
                    </a>
                </div>
            @endif
        </div>
        <div class="card-body pt-6">
            @include('pages.klinik.family_disease_histories._table')
        </div>
        <!--end::Card body-->
    </div>
    <!--end::Card-->

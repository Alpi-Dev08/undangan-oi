<div class="d-flex flex-row flex-center">
    @if(Auth::user()->can('klinik.update'))
        <a href="{{ route('family-disease-histories.edit', ['family_disease_history' => $model->id]) }}"
    ...
    @if(Auth::user()->can('klinik.delete'))
        {!! Form::open(['method' => 'DELETE', 'route' => ['family-disease-histories.destroy', $model->id], 'class' => '']) !!}

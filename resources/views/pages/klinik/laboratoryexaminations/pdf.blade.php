...
<header>
    <table style="width:100%;" cellspacing="15" class="border border-klinik">
        <tr style="vertical-align:baseline">
            ...
            <td style="width: 75%; vertical-align:top;text-align:left;border-left: 3px solid #4874ac;padding-left:10px;">
                <p style="font-size: 14px;margin:0px; padding:0px;">Ruko C-17, Pasar Modern Intermoda - BSD<br>Jl. Raya Cisauk Lapan, Sampora, Cisauk, Tangerang, Banten.
                </p>
                <p style="font-size: 12px;margin:0px; padding:0px;margin-top:5px;">
                    <img src="{{ public_path(theme()->getMediaUrlPath() . 'logos/wa.png') }}" alt="" style="height:10px;"> 0896 5886 8769
                    <img src="{{ public_path(theme()->getMediaUrlPath() . 'logos/call.png') }}" alt="" style="height:10px;margin-left:5px;"> 021 5569 8265
                    <img src="{{ public_path(theme()->getMediaUrlPath() . 'logos/globe.png') }}" alt="" style="height:10px;margin-left:5px;"> kliniksatriabudi.com
                    <img src="{{ public_path(theme()->getMediaUrlPath() . 'logos/ig.png') }}" alt="" style="height:10px;margin-left:5px;"> klinik.satriabudi</p>
            </td>
        </tr>
    </table>
    <table style="width:100%;border-top:0px !important;border-bottom: 0px !important;" class="border border-klinik">
        <tr style="vertical-align:baseline">
            <td colspan="4" style="width: 100%;text-align:center">
                <p style="margin:0px;font-size:22px;text-align:center;color:black;font-weight:bolder;text-transform:uppercase;font-family: 'Roboto Condensed', sans-serif;">HASIL LABORATORIUM</p>
            </td>
        </tr>
    </table>
    <table style="width:100%;border-top:0px !important;" class="border border-klinik">
        <tr>
            ...
            <td>
            <td style="width:30%;font-size:12px;">: {{ (!in_array($user->info->title_prefix,['','-']) ? $user->info->title_prefix.'. ' : '').$user->name.(!in_array($user->info->title_suffix,['','-']) ? ', '.$user->info->title_suffix : '') }}
            <td>
            <td style="width:20%;font-size:12px;font-weight:bold">Spesimen Diterima
            <td>
            <td style="width:30%;font-size:12px;">: {{ $laboratoryexaminations->created_at->locale('id')->translatedFormat('d F Y H:i:s') }}
            <td>
        </tr>
        <tr>
            ...
            <td>
            <td style="width:30%;font-size:12px;">: {{ $laboratoryexaminations->updated_at->locale('id')->translatedFormat('d F Y H:i:s') }}
            <td>
        </tr>
        <tr>
            <td style="width:20%;font-size:12px;font-weight:bold">Tanggal Lahir
            <td>
            <td style="width:30%;font-size:12px;">: {{  Carbon::parse($user->info->date_of_birth)->locale('id')->translatedFormat('d F Y') }}
            <td>

...
@for($i=0;$i<$jumlah;$i++)
    <div style="font-size:9px;height:2.3cm;width:6cm;border:1px solid black;padding: 5px;padding-top:2px;margin-right:5px;margin-bottom: 10px">
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>TTL</td>
                <td>: {{ Carbon::parse($examination->patient->user->info->date_of_birth)->locale('id')->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>

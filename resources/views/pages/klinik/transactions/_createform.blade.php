<!--begin::Form-->
<form id="kt_invoice_form" method="POST" class="form" action="{{ route('transactions.store') }}">
    {{ csrf_field() }}
    <!--begin::Wrapper-->
    <div class="mb-0">
        <!--begin::Row-->
        ...
        <div class="table-responsive mb-10">
            ...
            <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
                ...
                <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                    ...
                    <td>
                        <input type="text" class="form-control form-control-solid text-end" name="price[]" placeholder="0" value="0" data-kt-element="price" />
                    </td>

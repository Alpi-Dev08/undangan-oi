                        ...
                        <div class="row mb-6">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="email" class="form-control form-control-lg form-control-solid border border-gray-300" placeholder="{{ __('Email Address') }}" name="email" value="{{ old('email') }}" id="email"/>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="fv-row mb-0">
                                    <label for="current_password" class="form-label fs-6 fw-bolder mb-3">{{ __('Confirm Password') }}</label>
                                    <input type="password" class="form-control form-control-lg form-control-solid border border-gray-300" name="current_password" id="current_password"/>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="password" class="form-control form-control-lg form-control-solid border border-gray-300" name="password" id="password"/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="password" class="form-control form-control-lg form-control-solid border border-gray-300" name="password_confirmation" id="password_confirmation"/>
                                </div>
                            </div>
                        </div>

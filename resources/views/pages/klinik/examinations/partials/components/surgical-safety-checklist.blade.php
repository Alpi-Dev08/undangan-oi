    ...
    <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <p class="mb-0">{{ (!in_array($user->info->title_prefix, ['', '-']) ? $user->info->title_prefix . '. ' : '') . $user->name . (!in_array($user->info->title_suffix, ['', '-']) ? ', ' . $user->info->title_suffix : '') }}</p>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="identitas_pasien" id="identitas_pasien" checked>
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="inform_consnet" id="inform_consnet" checked>
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="row g-3">
                                     <div class="col-md-6">
                                         ...
                                         <input type="text" name="nama_operator" class="form-control form-control-solid border border-gray-300" placeholder="Masukkan nama operator">
                                     </div>
                                     <div class="col-md-6">
                                         <label class="form-label fw-bold">Nama Tindakan</label>
                                         <input type="text" name="nama_tindakan" class="form-control form-control-solid border border-gray-300" placeholder="Masukkan nama tindakan">
                                     </div>
                                     <div class="col-12">
                                         <label class="form-label fw-bold">Diagnosa</label>
                                         <input type="text" name="diagnosa" class="form-control form-control-solid border border-gray-300" placeholder="Masukkan diagnosa">
                                     </div>
                                 </div>
                             </div>
                         </div>
                                 ...
                                 <div class="row g-3">
                                     <div class="col-12">
                                         ...
                                         <div class="form-check form-check-custom form-check-solid mb-3">
                                             ...
                                             <label class="form-check-label fw-semibold" for="perdarahanTidak">Tidak perlu</label>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="mesinAnestesi">Mesin Anestesi</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" id="obatObatan"
                                                name="kelengkapan_anestesi_obat" value="Obat - obatan" checked />
                                            <label class="form-check-label fw-semibold" for="obatObatan">Obat - obatan</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="laboratorium">Laboratorium</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <p class="mb-0">{{ $examination->vitality->heart_rate ?? '-' }} kali/menit</p>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label fw-bold">Pernafasan:</label>
                                        <p class="mb-0">{{ $examination->vitality->respiratory_rate ?? '-' }} kali/menit</p>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="card border border-gray-300">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="alergiAda" name="riwayat_alergi"
                                                value="Ada" onchange="toggleKeterangan()" />
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="alergiTidakAda"
                                                name="riwayat_alergi" value="Tidak Ada" onchange="toggleKeterangan()" checked />
                                            <label class="form-check-label fw-semibold" for="alergiTidakAda">Tidak Ada</label>
                                        </div>
                                        <div id="keteranganContainer" style="display: none;" class="mt-3">
                                            <label for="keteranganAlergi" class="form-label fw-bold">Keterangan:</label>
                                            <textarea rows="3" class="form-control form-control-solid border border-gray-300" placeholder="Masukkan keterangan"
                        ...
                        <div class="card border border-gray-300">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="aspirasiTidak" name="aspirasi"
                                                value="Tidak" checked />
                                            <label class="form-check-label fw-semibold" for="aspirasiTidak">Tidak</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="aspirasiYa" name="aspirasi"
                                                value="Ya, dengan alat bantu" />
                                            <label class="form-check-label fw-semibold" for="aspirasiYa">Ya, dengan alat bantu</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="perdarahanTidak">Tidak</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="perdarahanYa"
                                                name="resiko_perdarahan" value="Ya, dengan dua IV line atau CVC" />
                                            <label class="form-check-label fw-semibold" for="perdarahanYa">Ya, dengan dua IV line atau CVC</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="tidakLengkap">Tidak Lengkap</label>
                                        </div>
                                        <div class="mt-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="alatInstrument">Instrument</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" id="membacakan"
                                                name="peran_tim_membacakan" value="Membacakan Secara Verbal" checked />
                                            <label class="form-check-label fw-semibold" for="membacakan">Membacakan Secara Verbal</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" id="tanggalTindakan"
                                                name="peran_tim_tanggal" value="Tanggal Tindakan" checked />
                                            <label class="form-check-label fw-semibold" for="tanggalTindakan">Tanggal Tindakan</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" id="namaPasien"
                                                name="peran_tim_nama_pasien" value="Nama Lengkap dan Tgl Lahir Pasien" checked />
                                            <label class="form-check-label fw-semibold" for="namaPasien">Nama Lengkap dan Tgl Lahir Pasien</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" id="diagnosa"
                                                name="peran_tim_diagnosa" value="Diagnosa" checked />
                                            <label class="form-check-label fw-semibold" for="diagnosa">Diagnosa</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                    ...
                    <div class="col-12">
                        <div class="card border border-gray-300">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Apakah tindakan yang dilakukan berisiko tinggi?</label>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="risikoTinggiYa"
                                                name="risiko_tinggi" value="Ya" />
                                            <label class="form-check-label fw-semibold" for="risikoTinggiYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="risikoTinggiTidak"
                                                name="risiko_tinggi" value="Tidak" checked />
                                            <label class="form-check-label fw-semibold" for="risikoTinggiTidak">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="perdarahanAntisipasiYa"
                                                name="perdarahan_antisipasi" value="Ya" checked />
                                            <label class="form-check-label fw-semibold" for="perdarahanAntisipasiYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="perdarahanAntisipasiTidak"
                                                name="perdarahan_antisipasi" value="Tidak" />
                                            <label class="form-check-label fw-semibold" for="perdarahanAntisipasiTidak">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card border border-gray-300">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Apakah ada perhatian / kekhawatiran pada pasien ini?</label>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="perhatianYa" name="perhatian"
                                                value="Ya" />
                                            <label class="form-check-label fw-semibold" for="perhatianYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="perhatianTidak" name="perhatian"
                                                value="Tidak" checked />
                                            <label class="form-check-label fw-semibold" for="perhatianTidak">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <label class="form-label fw-bold">Apakah ada peralatan yang perlu disediakan (darah)?</label>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="peralatanYa" name="peralatan"
                                                value="Ya" />
                                            <label class="form-check-label fw-semibold" for="peralatanYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mb-3">
                                            <input class="form-check-input" type="radio" id="peralatanTidak" name="peralatan"
                                                value="Tidak" checked />
                                            <label class="form-check-label fw-semibold" for="peralatanTidak">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h3 class="card-title fw-bold text-gray-800">PERAWAT</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Apakah sudah mengecek sterilisasi alat (melalui indikator sterilisasi)?</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="sterilisasiYa" name="sterilisasi"
                                    value="Ya" checked />
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Apakah ada kesiapan peralatan yang harus diperhatikan?</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="peralatanKesiapanYa"
                                    name="kesiapan_peralatan" value="Ya" onchange="toggleKeterangan(this)" />
                                <label class="form-check-label fw-semibold text-black"
                                    for="peralatanKesiapanYa">Ya</label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="peralatanKesiapanTidak"
                                    name="kesiapan_peralatan" value="Tidak" onchange="toggleKeterangan(this)"
                                    checked />
                                <label class="form-check-label fw-semibold text-black"
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h3 class="card-title fw-bold text-gray-800">ANTIBIOTIK PROPHYLAXIS</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Apakah sudah diberikan dalam waktu sekurangnya 60 menit sebelum tindakan?</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="antibiotikYa" name="antibiotik"
                                    value="Ya" />
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label class="form-label fw-semibold text-black">Nama Obat</label>
                                <input type="text" name="nama_obat"
                                    class="form-control form-control-solid border border-gray-300"
                                    placeholder="Nama Obat">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label fw-semibold text-black">Dosis Obat</label>
                                <input type="text" name="dosis_obat"
                                    class="form-control form-control-solid border border-gray-300"
                                    placeholder="Dosis Obat">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label fw-semibold text-black">Jam diberikan</label>
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h3 class="card-title fw-bold text-gray-800">FOTO PEMERIKSAAN RADIOLOGI YANG DIPERLUKAN</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-4">
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h3 class="card-title fw-bold text-gray-800">SIGN OUT (Sebelum pasien keluar kamar tindakan)</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <h5 class="fw-bold text-gray-800 mb-3">Secara Verbal Perawat Memastikan:</h5>
                        <label class="form-label fw-semibold text-black">Nama Tindakan</label>
                        <input type="text" name="nama_tindakan"
                            class="form-control form-control-solid border border-gray-300"
                            placeholder="Nama Tindakan">
                    </div>
                    <div class="col-md-6 mb-4">
                        <h5 class="fw-bold text-gray-800 mb-3">Kelengkapan Alat:</h5>
                        <div class="form-check form-check-custom form-check-solid mb-3">
                            <input class="form-check-input" type="checkbox" id="alatInstrument"
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Pelabelan specimen</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="pelabelanSpecimenYa"
                                    name="pelabelan_specimen" value="ya" onchange="toggleKeterangan(this)" />
                                <label class="form-check-label fw-semibold text-black"
                                    for="pelabelanSpecimenYa">Ya</label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="pelabelanSpecimenTidak"
                                    name="pelabelan_specimen" value="tidak" onchange="toggleKeterangan(this)"
                                    checked />
                                <label class="form-check-label fw-semibold text-black"
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">JENIS SPECIMEN</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="checkbox" id="pa" name="pemeriksaan_pa"
                                    value="PA" />
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Apakah ada masalah peralatan yang perlu disampaikan dari dokter Bedah?</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Formulir permintaan pemeriksaan</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                            ...
                            <div class="form-check form-check-custom form-check-solid mb-3">
                                <input class="form-check-input" type="radio" id="formulirPemeriksaanTidak"
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Telah dilengkapi identitas pasien</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold text-black">Penjelasan oleh operator kepada keluarga pasien</label>
                        <div class="mt-3">
                            <div class="form-check form-check-custom form-check-solid mb-3">
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <label class="form-label fw-semibold text-black">OBAT - OBATAN YANG DIBERIKAN SELAMA OPERASI</label>
                        <div class="mt-3">
                            <div class="d-flex align-items-center mb-3">
                                <div class="form-check form-check-custom form-check-solid me-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="form-check form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="radio" id="obatTidakDiberikan"
                                        name="obat_operasi" value="Tidak diberikan" checked />
                                    <label class="form-check-label fw-semibold text-black"
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><strong>PEMERIKSAAN TANDA VITAL</strong></h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Saturasi O2</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Pernafasan</label>
                                <input type="text" name="pernafasan_1"
                                    class="form-control form-control-solid border border-gray-300"
                                    placeholder="Pernafasan (kali/menit)">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Skala nyeri</label>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><strong>Periksa kembali luka operasi</strong></h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-check form-check-custom form-check-solid mb-3">
                                    <input class="form-check-input" type="radio" id="lukaOperasiAdaRembesan"
                                        name="luka_operasi" value="Ada rembesan" />
                                    <label class="form-check-label fw-semibold text-black"
                                        for="lukaOperasiAdaRembesan">Ada rembesan</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid mb-3">
                                    <input class="form-check-input" type="radio" id="lukaOperasiTidakAdaRembesan"
                                        name="luka_operasi" value="Tidak ada rembesan" checked />
                                    <label class="form-check-label fw-semibold text-black"
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><strong>Tanda Tangan</strong></h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">

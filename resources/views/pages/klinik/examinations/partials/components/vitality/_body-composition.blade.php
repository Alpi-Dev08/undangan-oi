...
<div class="col-6 mb-6">
    ...
    <input id="body_mass_index" name="body_mass_index" type="number" step="0.01"
        class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 text-primary @error('body_mass_index') is-invalid @enderror"
...
<div class="col-6 mb-6">
    ...
    <input id="ideal_weight" name="ideal_weight" type="number" step="0.01"
        class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 text-primary @error('ideal_weight') is-invalid @enderror"
...
<div class="col-6 mb-6">
    ...
    <input id="bmi_conclusion" name="bmi_conclusion" type="text"
        ...
        placeholder="Normal" value="{{ $vitalityexamination->bmi_conclusion ?? '' }}" text-primary />

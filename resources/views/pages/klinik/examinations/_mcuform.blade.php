                                ...
                                <div class="fw-mormal timeline-content text-muted ps-3">
                                    ...
                                    <div class="row p-2 border border-gray-200 bg-gray-100 rounded">
                                        ...
                                        @if($exam->service_category->is_mcu == 1)
                                            ...
                                            @if(isset($exam->additional->additional_value))
                                                <h3 class="col-12">4. Additional Examination</h3>
                                                @php
                                                    $additionals = json_decode($exam->additional->additional_value);
                                                    $header = '';
                                                @endphp
                                                @foreach($additionals as $key => $value)
                                                    ...
                                                    @if($additional[$additionalKeys[0]])
                                                        @if($header != getAdditional($key)->additionals_category_id)
                                                            <div class="col-12 fw-bold" style="padding-left:35px;font-size:14px;">{{ getAdditionalCategory(getAdditional($key)->additionals_category_id)->name }}</div>
                                                            @php $header = getAdditional($key)->additionals_category_id; @endphp
                                                        @endif
                                                        <div class="col-12 row">
                                                            <div class="col-4 fw-bold" style="padding-left:50px">{{getAdditional($key)->name }}</div>
                                                            <div class="col-8">: {{ ucwords(str_replace("-"," ",$additional[$additionalKeys[0]])) }}</div>
                                                        </div>
                                                    @endif
                                                @endforeach
                                            @endif
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    @if(isset($additionalexamination->id))
                        <form id="kt_modal_add_examinations_form" method="POST" class="form" enctype="multipart/form-data"
                            ...
                            @else
                                <form id="kt_modal_add_examinations_form" method="POST" class="form" enctype="multipart/form-data"
                                      action="{{ route('additionalexaminations.store') }}">
                                    @method('POST')
                                    {{ csrf_field() }}
                                    @endif
                                    <input type="hidden" name="examination_id" value="{{ $examination->id }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            @php
                                                                ...
                                                                $option = [];
                                                                if(isset($additionalexamination->id)){
                                                                    $option = json_decode($additionalexamination->additional_value,true);
                                                                }
                                                                            ...
                                                                            @elseif($additional->type == "select")
                                                                                <select
                                                                                    ...
                                                                                    @foreach(explode('_',$additional->value) as $option)
                                                                                        <option
                                                                                            value="{{ $option }}"
                                                                                            @if(isset($adt[$additional->name]))
                                                                                                @if($adt[$additional->name] == $option)
                                                                                                    selected="selected"
                                                                                            @endif
                                                                                            @endif
                                                                                        >{{ ucwords(str_replace("-"," ",$option)) }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        @endif
                                                                    @endforeach
...
@push('customscript')
    <script>
        ...
        $(function () {
            ...
            if(gender_id==1) {
                $("#farming_diabetes_melitus").val() == "yes" ? $("#farming_score_diabetes_melitus").val(2) : $("#farming_score_diabetes_melitus").val(0);
            }else{
                $("#farming_diabetes_melitus").val() == "yes" ? $("#farming_score_diabetes_melitus").val(4) : $("#farming_score_diabetes_melitus").val(0);
            }
            ...
            $("#farmig_score_total_cholesterol").val(farmingScoreTotalColesterol($("#total_cholesterol").val(),gender_id));
            $("#total_cholesterol").change(function () {
                $("#farmig_score_total_cholesterol").val(farmingScoreTotalColesterol($(this).val(),gender_id));
            });

            $("#farming_score_hdl_cholesterol").val(farmingScoreHdlColesterol($("#hdl_cholesterol").val(),gender_id));
            $("#hdl_cholesterol").change(function () {
                $("#farming_score_hdl_cholesterol").val(farmingScoreHdlColesterol($(this).val(),gender_id));
            });

            $("#farming_score_systolic_blood_pressure").val(farmingScoreSystolicBloodPlessure($("#systolic_blood_pressure").val(),gender_id));
            $("#systolic_blood_pressure").change(function () {
                $("#farming_score_systolic_blood_pressure").val(farmingScoreSystolicBloodPlessure($(this).val(),gender_id));
            });

            $("#farming_smoking").val()=="yes" ? $("#farming_score_smoking").val(2) : $("#farming_score_smoking").val(0);
            $("#farming_smoking").change(function () {
                $(this).val()=="yes" ? $("#farming_score_smoking").val(2) : $("#farming_score_smoking").val(0);
            });

            $("#sex").val(gender);
            $("#score_sex").val(gender_id==1?1:0);
            $("#sex").change(function(){
                if($(this).val().toLowerCase()==0 || $(this).val().toLowerCase()=="female" || $(this).val().toLowerCase()=="wanita" || $(this).val().toLowerCase()=="perempuan"){
                    $("#score_sex").val(0);
                } else {
                    $("#score_sex").val(1);
                }
            ...
            $("#cardio_diabetes_melitus").val()=="yes"?$("#cardio_score_diabetes_melitus").val(2):$("#cardio_score_diabetes_melitus").val(0);

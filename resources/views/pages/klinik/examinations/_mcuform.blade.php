                            ...
                            <div class="row col-12">
                                <div class="row col-6">
                                    ...
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-8">: {{ $examination->vitality->body_mass_index ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                        <div class="col-4">Ideal Weight</div>
                                        <div class="col-8">: {{ $examination->vitality->ideal_weight ?? '-' }} Kg
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                    ...
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-8">: {{ $examination->vitality->bmi_conclusion ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12">&nbsp;</div>
                                    <div class="col-12 row">
                                        <div class="col-4">Arm Circumference</div>
                                        <div class="col-8">: {{ $examination->vitality->arm_circumference ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                        <div class="col-4">Abdominal Circumference</div>
                                        <div class="col-8">:
                                            {{ $examination->vitality->adbdominal_circumference ?? '-' }}</div>
                                    </div>
                                </div>
                                <div class="row col-6">
                                    <div class="col-12 row">
                                        <div class="col-4">Blood Pressure</div>
                                        <div class="col-8">: {{ $examination->vitality->blood_pressure ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                    ...
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-8">: {{ $examination->vitality->respiratory_rate ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                    ...
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-8">: {{ $examination->vitality->oxygen_saturation ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">
                                        <div class="col-4">Waist Circumference</div>
                                        <div class="col-8">:
                                            {{ $examination->vitality->waist_circumferennce ?? '-' }}</div>
                                    </div>
                                    <div class="col-12">&nbsp;</div>
                                    <div class="col-12 row">
                                        <div class="col-4">Neck Circumference</div>
                                        <div class="col-8">: {{ $examination->vitality->neck_circumference ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-12 row">

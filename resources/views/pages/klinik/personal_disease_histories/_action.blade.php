<div class="d-flex flex-row flex-center">
    @if(Auth::user()->can('klinik.update'))
        <a href="{{ route('personal-disease-histories.edit', ['personal_disease_history' => $model->id]) }}"
    ...
    @if(Auth::user()->can('klinik.delete'))
        {!! Form::open(['method' => 'DELETE', 'route' => ['personal-disease-histories.destroy', $model->id], 'class' => '']) !!}

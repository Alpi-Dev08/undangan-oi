<form id="kt_modal_edit_personal_disease_history_form" method="POST" class="form" action="{{ route('personal-disease-histories.update', ['personal_disease_history' => $personal_disease_history->id]) }}">
    @method('PUT')
    {{ csrf_field() }}
    <!--begin::Scroll-->

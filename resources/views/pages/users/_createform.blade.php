            ...
            <div class="fv-row col-6 mb-7">
                ...
                <div class="input-group input-group-solid has-validation mb-3">
                    <input type="text" name="first_name"
                           class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('first_name') is-invalid @enderror"
            ...
            <div class="fv-row col-6 mb-7">
                ...
                <div class="input-group input-group-solid has-validation mb-3">
                    <input type="text" name="last_name"
                           class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('last_name') is-invalid @enderror"
            ...
            <div class="fv-row col-6 mb-7">
                ...
                <div class="input-group input-group-solid has-validation mb-3">
                    <input type="email" name="email"
                           class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('email') is-invalid @enderror"
            ...
            <div class="fv-row col-6 mb-7">
                ...
                <div class="input-group input-group-solid has-validation mb-3">
                    <input type="text" name="phone"
                           class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('phone') is-invalid @enderror"
            ...
            <div class="fv-row col-6 mb-7">
                ...
                <div class="input-group input-group-solid has-validation mb-3">
                    <input type="password" name="password"
                           class="form-control form-control-solid border border-gray-300 mb-3 mb-lg-0 @error('password') is-invalid @enderror"
                           value=""/>
                </div>
                <!--end::Input-->
            </div>

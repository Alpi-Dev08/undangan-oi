<x-base-layout>
    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" id="searchbox" class="form-control form-control-solid border border-gray-300 w-250px ps-15" placeholder="Search Relationship Status">
                </div>
            ...
            @if(Auth::user()->can('masters.create'))
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                    ...
                    <a href="{{ route('relationshipstatuses.create')  }}" class="btn btn-sm btn-light-primary">
        ...
        <div class="card-body pt-6">
            @include('pages.masters.relationshipstatuses._table')
        </div>
        <!--end::Card body-->
    </div>
    <!--end::Card-->

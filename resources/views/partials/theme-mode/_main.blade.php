...
<a href="#" class="{{ $btnClass }} " data-kt-menu-trigger="{{ $trigger }}" data-kt-menu-attach="parent" data-kt-menu-placement="{{ $menuPlacement }}">
    {!! theme()->getSvgIcon('demo1/media/icons/duotune/general/gen060.svg', 'theme-light-show ' . $iconClass ) !!}
    {!! theme()->getSvgIcon('demo1/media/icons/duotune/general/gen061.svg', 'theme-dark-show ' . $iconClass ) !!}
</a>
<!--begin::Menu toggle-->

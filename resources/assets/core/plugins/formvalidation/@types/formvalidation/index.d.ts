...
declare module 'formvalidation/algoritklinik/luhn' {
    function luhn(value: string): boolean;
    export = luhn;
}

declare module 'formvalidation/algoritklinik/mod11And10' {
    function mod11And10(value: string): boolean;
    export = mod11And10;
}

declare module 'formvalidation/algoritklinik/mod37And36' {
    function mod37And36(value: string, alphabet?: string): boolean;
    export = mod37And36;
}

declare module 'formvalidation/algoritklinik/mod97And10' {
    function mod97And10(value: string): boolean;
    export = mod97And10;
}

declare module 'formvalidation/algoritklinik/verhoeff' {

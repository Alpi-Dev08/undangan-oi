...
> {
    ...
    return {
        validate(
            ...
            if (timeFormat) {
                const klinik = timeSection.split(':');
                ...
                const h =
                    klinik.length > 0
                        ? klinik[0].length <= 2 && /^\d+$/.test(klinik[0])
                            ? parseInt(klinik[0], 10)
                            : -1
                        : 0;
                const m =
                    klinik.length > 1
                        ? klinik[1].length <= 2 && /^\d+$/.test(klinik[1])
                            ? parseInt(klinik[1], 10)
                            : -1
                        : 0;
                const s =
                    klinik.length > 2
                        ? klinik[2].length <= 2 && /^\d+$/.test(klinik[2])
                            ? parseInt(klinik[2], 10)
                            : -1
                        : 0;

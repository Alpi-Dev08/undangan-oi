        ...
        var items = new vis.DataSet([
            {
                ...
                content: getContent('Conversation', hostUrl + '/media/photos/300-6.jpg')
            },
            {
                start: new Date(2010, 7, 23, 23, 0, 0),
                content: getContent('Mail from boss', hostUrl + '/media/photos/300-1.jpg')
            },
            ...
            },
            {
                ...
                content: getContent('Memo', hostUrl + '/media/photos/300-2.jpg')
            },
            {
                start: new Date(2010, 7, 29),
                content: getContent('Phone call', hostUrl + '/media/photos/300-5.jpg')
            },
            {
            ...
            },
            {
                ...
                content: getContent('Report', hostUrl + '/media/photos/300-20.jpg')
            },
        ]);

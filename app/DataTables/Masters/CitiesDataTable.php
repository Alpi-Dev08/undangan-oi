    ...
    class CitiesDataTable extends DataTable
    {
        ...
        public function dataTable($query)
        {
            return datatables()
                ...
                ->rawColumns(['action'])
                ->addIndexColumn()
                ->addColumn('area_code', function (City $model) {
                    return $model->area_code;
                })
                ->addColumn('country', function (City $model) {
                    return $model->country->name;
                })
                ->addColumn('province', function (City $model) {
                    return $model->province->name;
                })
                ->addColumn('name', function (City $model) {
                    return $model->name;
                })
                ->addColumn('action', function (City $model) {
                    return view('pages.masters.cities._action', compact('model'));
                });
        }

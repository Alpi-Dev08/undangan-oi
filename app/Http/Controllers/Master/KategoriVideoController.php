...
use App\DataTables\Masters\KategoriVideoDataTable;
use App\Models\Master\Kategori;
use App\Models\Master\Jenis;
use App\Http\Requests\Master\StoreKategoriVideoRequest;
use App\Http\Requests\Master\UpdateKategoriVideoRequest;
...
class KategoriVideoController extends Controller
{
     ...
     */
    public function index(KategoriVideoDataTable $dataTable)
    {
        if (is_null($this->user) || !$this->user->can('masters.read')) {
            abort(403, 'Sorry !! You are Unauthorized to view any master data !');
        }

        return $dataTable->render('pages.masters.kategori_video.index');
    }
    ...
    public function create()
    {
        ...
        return view('pages.masters.kategori_video.create');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreKategoriVideoRequest $request)
    {
        if (is_null($this->user) || !$this->user->can('masters.create')) {
            abort(403, 'Sorry !! You are Unauthorized to create any master data !');
        }
        ...
        return redirect()->route('kategori_video.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            'pages.masters.kategori_video.edit',
     ...
     *
     * @param \App\Http\Requests\UpdateKategoriVideoRequest $request
     * @param \App\Models\kategori                     $kategori
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateKategoriVideoRequest $request, $id)
    {
        if (is_null($this->user) || !$this->user->can('masters.update')) {
            abort(403);
        }

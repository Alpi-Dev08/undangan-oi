...
class HealthProfesionalsController extends Controller
{
    ...
    public function index(NakesDataTable $dataTable)
    {
    ...
    public function store(SettingsInfoRequest $request)
    {
        ...
        $roles = Role::where('name', 'nakes')->first();
        ...
        return redirect()->intended('klinik/healthprofesionals');

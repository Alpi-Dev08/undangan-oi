...
class FamilyDiseaseHistoryController extends Controller
{
    public function index()
    {
        ...
        return view('pages.klinik.family_disease_histories.index', compact('familyDiseaseHistories'));
    }
    ...
    public function store(StoreFamilyDiseaseHistoryRequest $request)
    {
        ...
        return redirect()->route('family-disease-histories.index')->with('success', 'Family Disease History created successfully.');
    }
    ...
    public function update(UpdateFamilyDiseaseHistoryRequest $request, FamilyDiseaseHistory $familyDiseaseHistory)
    {
        ...
        return redirect()->route('family-disease-histories.index')->with('success', 'Family Disease History updated successfully.');
    }

    public function destroy(FamilyDiseaseHistory $familyDiseaseHistory)
    {
        $familyDiseaseHistory->delete();
        return redirect()->route('family-disease-histories.index')->with('success', 'Family Disease History deleted successfully.');
    }
}
